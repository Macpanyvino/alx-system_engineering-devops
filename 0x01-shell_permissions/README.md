This  is a note on that explains the actions of each script written in this alx devops task on shell permissions. The following are the instructions written as a script in each file and accordingly:
